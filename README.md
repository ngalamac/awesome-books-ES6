...
**[Awesome Books]** is an HTML, CSS and Javascript project
...
```sh
  ...
  git clone https://github.com/ngalamac/Awesome-Books-ES6.git
```
...
- A more complex and organised layout
- user dashboard
